 ...
 *  File Size        : 1834720 bytes
 *  Date Time        : 2019/08/22 20:10:55
 *  Target           : Public
 *  Cues             : 10
 *  CueSheet Comment : 
...
#define CRI_PROPELLER_AISACCONTROL_PIOPELLERBGM_B       ( 1) /*  */
#define CRI_PROPELLER_AISACCONTROL_PIOPELLERBGM_C       ( 2) /*  */
#define CRI_PROPELLER_AISACCONTROL_PIOPELLERBGM_D       ( 3) /*  */

/* Cue List (Cue ID) */
#define CRI_PROPELLER_SE_WIND              ( 0) /*  */
