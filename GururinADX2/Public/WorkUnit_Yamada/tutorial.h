 ...
 *  Cues             : 1
 *  CueSheet Comment : 
 *  Stream Awb Path  : /Users/yamadachihiro/Documents/CRIWARE/CriAtomCraft/GururinADX2/Public/WorkUnit_Yamada/tutorial.awb
 *===========================================================================*/

#define CRI_TUTORIAL_CUENUM (1)

/* AISAC Control List (AISAC Control ID) */

/* Cue List (Cue ID) */
#define CRI_TUTORIAL_BGM_TUTOLIAL         ( 0) /*  */
